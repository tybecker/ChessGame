...
public class Rook implements ChessPiece{
	 ...
	 * rook can legally perform.  This method is primarily for the use of
	...
	public void draw(Graphics g) {
		if(color == 0){
			g.drawImage(Images.pieces[2], xCoordinate, yCoordinate, 78, 78, null);
		}else{
			g.drawImage(Images.pieces[3], xCoordinate, yCoordinate, 78, 78, null);
		}
	}
	...
	public ChessPiece copy() {
		ChessPiece newRook = new Rook(color, xLocation, yLocation);
		newRook.setCoordinates(xCoordinate, yCoordinate);
		return newRook;
	}
