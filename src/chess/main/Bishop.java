...
public class Bishop implements ChessPiece{
	 ...
	 */
	public Bishop(int color, int xLoc, int yLoc){
		this.color = color;
		xLocation = xLoc;
		yLocation = yLoc;
		xCoordinate = 0;
	 ...
	 * bishop can legally perform.  This method is primarily for the use of
	...
	public void draw(Graphics g) {
		if(color == 0){
			g.drawImage(Images.pieces[6], xCoordinate, yCoordinate, 78, 78, null);
		}else{
			g.drawImage(Images.pieces[7], xCoordinate, yCoordinate, 78, 78, null);
		}
	}
	...
	public ChessPiece copy() {
		ChessPiece newBishop = new Bishop(color, xLocation, yLocation);
		newBishop.setCoordinates(xCoordinate, yCoordinate);
		return newBishop;
	}
